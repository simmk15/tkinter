...
class RestrauntOrderManagement:
    def __init__(self,root): 
        ...
        ttk.Label(frame,text="Restraunt Order Management",font=("Arial",20,"bold")).grid(row=0,columnspan=3,padx=10,pady=10)
        self.menu_labels={}
        ...
        currency_dropdown=ttk.Combobox(frame,textvariable=self.curency_var,state="readonly",width=18,values=("USD","INR"))
